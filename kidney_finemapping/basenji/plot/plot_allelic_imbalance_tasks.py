...
from kidney_finemapping.basenji.plot.compare_auc_delong_xu import \
    delong_roc_variance
from kidney_finemapping.kidney_utils import (KIDNEY_CMAP,
                                             PLOT_KIDNEY_TARGET_INDICES)
...
def main():
    ...
    # Plot allelic imbalance direction
    ...
    for data in data_per_target:
        ...
        # get predicted imbalance
        ref = pos_sad["REF"][:, ti].squeeze()
        alt = pos_sad["ALT"][:, ti].squeeze()
        imb_preds = ref / (ref + alt)
